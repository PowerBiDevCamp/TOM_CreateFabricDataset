...
**Customer** and **Age**. It also drops two other columns named **FirstName** and **LastName**.
...
table and the **silver_invoice_details** table into a single DataFrame by calling **join()**.
...
now see the four gold zone tables named **calendar**, **customers**, **products** and
